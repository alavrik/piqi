   ...
   in
     Piqirun.gen_record code
       [ _unparsed_piq_ast; _code; _proto_name; _name; _piqtype; _alt_name;
         _getopt_letter; _typename; _piq_format; _ocaml_name; _getopt_doc;
         _json_name ])
   ...
   in
     Piqirun.gen_record code
       [ _unparsed_piq_ast; _code; _proto_name; _mode; _name; _piqtype;
         ...
         _ocaml_name; _wire_packed; _getopt_doc; _default; _ocaml_optional;
         _json_name ])
