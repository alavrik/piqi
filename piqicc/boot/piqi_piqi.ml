...
and parse_piqi_bundle x =
  ...
  in
    refer count
      (let (_piqi, x) = Piqirun.parse_repeated_field 2 parse_piqi x
...
and gen__piqi_bundle code x =
  (refer x;
   let _piqi = Piqirun.gen_repeated_field 2 gen__piqi x.Piqi_bundle.piqi
