...
module rec Descriptor_piqi:
  sig
    ...
    type descriptor_proto_extension_range = Descriptor_proto_extension_range.t
    type field_descriptor_proto = Field_descriptor_proto.t
    type enum_descriptor_proto = Enum_descriptor_proto.t
    type enum_value_descriptor_proto = Enum_value_descriptor_proto.t
    ...
    type uninterpreted_option_name_part = Uninterpreted_option_name_part.t
  end = Descriptor_piqi
and File_descriptor_set:
  sig
    type t = {
      mutable file: Descriptor_piqi.file_descriptor_proto list;
    }
  end = File_descriptor_set
and File_descriptor_proto:
  sig
    type t = {
...
and Descriptor_proto:
  sig
    type t = {
      ...
      mutable enum_type: Descriptor_piqi.enum_descriptor_proto list;
      mutable extension_range: Descriptor_piqi.descriptor_proto_extension_range list;
      mutable options: Descriptor_piqi.message_options option;
    }
  end = Descriptor_proto
and Descriptor_proto_extension_range:
  sig
    type t = {
...
and Enum_value_descriptor_proto:
  sig
    type t = {
      mutable name: string option;
      mutable number: Descriptor_piqi.protobuf_int32 option;
...
and File_options:
  sig
    type t = {
      ...
      mutable uninterpreted_option: Descriptor_piqi.uninterpreted_option list;
    }
  end = File_options
and Message_options:
  sig
...
and Uninterpreted_option_name_part:
  sig
    type t = {
...
and parse_file_descriptor_set x =
  ...
  let _file, x = Piqirun.parse_repeated_field 1 parse_file_descriptor_proto x in
  Piqirun.check_unparsed_fields x;
  {
    File_descriptor_set.file = _file;
  }
...
and parse_file_descriptor_proto x =
  ...
  let _message_type, x = Piqirun.parse_repeated_field 4 parse_descriptor_proto x in
  let _enum_type, x = Piqirun.parse_repeated_field 5 parse_enum_descriptor_proto x in
  let _service, x = Piqirun.parse_repeated_field 6 parse_service_descriptor_proto x in
  let _extension, x = Piqirun.parse_repeated_field 7 parse_field_descriptor_proto x in
  let _options, x = Piqirun.parse_optional_field 8 parse_file_options x in
  Piqirun.check_unparsed_fields x;
  {
...
and parse_descriptor_proto x =
  let x = Piqirun.parse_record x in
  let _name, x = Piqirun.parse_optional_field 1 parse_string x in
  let _field, x = Piqirun.parse_repeated_field 2 parse_field_descriptor_proto x in
  let _nested_type, x = Piqirun.parse_repeated_field 3 parse_descriptor_proto x in
  let _enum_type, x = Piqirun.parse_repeated_field 4 parse_enum_descriptor_proto x in
  let _extension_range, x = Piqirun.parse_repeated_field 5 parse_descriptor_proto_extension_range x in
  let _extension, x = Piqirun.parse_repeated_field 6 parse_field_descriptor_proto x in
  let _options, x = Piqirun.parse_optional_field 7 parse_message_options x in
  Piqirun.check_unparsed_fields x;
  {
...
and parse_descriptor_proto_extension_range x =
  ...
  let _p_end, x = Piqirun.parse_optional_field 2 parse_protobuf_int32 x in
  Piqirun.check_unparsed_fields x;
  {
...
and parse_field_descriptor_proto x =
  ...
  let _label, x = Piqirun.parse_optional_field 4 parse_field_descriptor_proto_label x in
  let _p_type, x = Piqirun.parse_optional_field 5 parse_field_descriptor_proto_type x in
  ...
  let _options, x = Piqirun.parse_optional_field 8 parse_field_options x in
  Piqirun.check_unparsed_fields x;
  {
...
and parse_enum_descriptor_proto x =
  let x = Piqirun.parse_record x in
  let _name, x = Piqirun.parse_optional_field 1 parse_string x in
  let _value, x = Piqirun.parse_repeated_field 2 parse_enum_value_descriptor_proto x in
  let _options, x = Piqirun.parse_optional_field 3 parse_enum_options x in
  Piqirun.check_unparsed_fields x;
  {
...
and parse_enum_value_descriptor_proto x =
  ...
  let _options, x = Piqirun.parse_optional_field 3 parse_enum_value_options x in
  Piqirun.check_unparsed_fields x;
  {
...
and parse_service_descriptor_proto x =
  let x = Piqirun.parse_record x in
  let _name, x = Piqirun.parse_optional_field 1 parse_string x in
  let _p_method, x = Piqirun.parse_repeated_field 2 parse_method_descriptor_proto x in
  let _options, x = Piqirun.parse_optional_field 3 parse_service_options x in
  Piqirun.check_unparsed_fields x;
  {
...
and parse_method_descriptor_proto x =
  ...
  let _options, x = Piqirun.parse_optional_field 4 parse_method_options x in
  Piqirun.check_unparsed_fields x;
  {
...
and parse_file_options x =
  ...
  let _java_outer_classname, x = Piqirun.parse_optional_field 8 parse_string x in
  let _optimize_for, x = Piqirun.parse_required_field 9 parse_file_options_optimize_mode x ~default:"\b\001" in
  let _java_multiple_files, x = Piqirun.parse_required_field 10 parse_bool x ~default:"\b\000" in
  let _cc_generic_services, x = Piqirun.parse_required_field 16 parse_bool x ~default:"\b\001" in
  let _java_generic_services, x = Piqirun.parse_required_field 17 parse_bool x ~default:"\b\001" in
  let _py_generic_services, x = Piqirun.parse_required_field 18 parse_bool x ~default:"\b\001" in
  let _uninterpreted_option, x = Piqirun.parse_repeated_field 999 parse_uninterpreted_option x in
  Piqirun.check_unparsed_fields x;
  {
...
and parse_message_options x =
  let x = Piqirun.parse_record x in
  let _message_set_wire_format, x = Piqirun.parse_required_field 1 parse_bool x ~default:"\b\000" in
  let _no_standard_descriptor_accessor, x = Piqirun.parse_required_field 2 parse_bool x ~default:"\b\000" in
  let _uninterpreted_option, x = Piqirun.parse_repeated_field 999 parse_uninterpreted_option x in
  Piqirun.check_unparsed_fields x;
  {
    Message_options.message_set_wire_format = _message_set_wire_format;
    Message_options.no_standard_descriptor_accessor = _no_standard_descriptor_accessor;
    Message_options.uninterpreted_option = _uninterpreted_option;
  }

and parse_field_options x =
  let x = Piqirun.parse_record x in
  let _ctype, x = Piqirun.parse_required_field 1 parse_field_options_ctype x ~default:"\b\000" in
  let _packed, x = Piqirun.parse_optional_field 2 parse_bool x in
  let _deprecated, x = Piqirun.parse_required_field 3 parse_bool x ~default:"\b\000" in
  let _experimental_map_key, x = Piqirun.parse_optional_field 9 parse_string x in
  let _uninterpreted_option, x = Piqirun.parse_repeated_field 999 parse_uninterpreted_option x in
  Piqirun.check_unparsed_fields x;
  {
...
and parse_uninterpreted_option x =
  let x = Piqirun.parse_record x in
  let _name, x = Piqirun.parse_repeated_field 2 parse_uninterpreted_option_name_part x in
  let _identifier_value, x = Piqirun.parse_optional_field 3 parse_string x in
  let _positive_int_value, x = Piqirun.parse_optional_field 4 parse_uint64 x in
  let _negative_int_value, x = Piqirun.parse_optional_field 5 parse_protobuf_int64 x in
  let _double_value, x = Piqirun.parse_optional_field 6 parse_float64 x in
  let _string_value, x = Piqirun.parse_optional_field 7 parse_binary x in
  Piqirun.check_unparsed_fields x;
  {
...
and parse_uninterpreted_option_name_part x =
  ...
  let _is_extension, x = Piqirun.parse_required_field 2 parse_bool x in
  Piqirun.check_unparsed_fields x;
  {
...
and gen__file_descriptor_set code x =
  let _file = Piqirun.gen_repeated_field 1 gen__file_descriptor_proto x.File_descriptor_set.file in
  Piqirun.gen_record code (_file :: [])

and gen__file_descriptor_proto code x =
  let _name = Piqirun.gen_optional_field 1 gen__string x.File_descriptor_proto.name in
  let _package = Piqirun.gen_optional_field 2 gen__string x.File_descriptor_proto.package in
  let _dependency = Piqirun.gen_repeated_field 3 gen__string x.File_descriptor_proto.dependency in
  let _message_type = Piqirun.gen_repeated_field 4 gen__descriptor_proto x.File_descriptor_proto.message_type in
  let _enum_type = Piqirun.gen_repeated_field 5 gen__enum_descriptor_proto x.File_descriptor_proto.enum_type in
  let _service = Piqirun.gen_repeated_field 6 gen__service_descriptor_proto x.File_descriptor_proto.service in
  let _extension = Piqirun.gen_repeated_field 7 gen__field_descriptor_proto x.File_descriptor_proto.extension in
  let _options = Piqirun.gen_optional_field 8 gen__file_options x.File_descriptor_proto.options in
  Piqirun.gen_record code (_name :: _package :: _dependency :: _message_type :: _enum_type :: _service :: _extension :: _options :: [])

and gen__descriptor_proto code x =
  let _name = Piqirun.gen_optional_field 1 gen__string x.Descriptor_proto.name in
  let _field = Piqirun.gen_repeated_field 2 gen__field_descriptor_proto x.Descriptor_proto.field in
  let _nested_type = Piqirun.gen_repeated_field 3 gen__descriptor_proto x.Descriptor_proto.nested_type in
  let _enum_type = Piqirun.gen_repeated_field 4 gen__enum_descriptor_proto x.Descriptor_proto.enum_type in
  let _extension_range = Piqirun.gen_repeated_field 5 gen__descriptor_proto_extension_range x.Descriptor_proto.extension_range in
  let _extension = Piqirun.gen_repeated_field 6 gen__field_descriptor_proto x.Descriptor_proto.extension in
  let _options = Piqirun.gen_optional_field 7 gen__message_options x.Descriptor_proto.options in
  Piqirun.gen_record code (_name :: _field :: _nested_type :: _enum_type :: _extension_range :: _extension :: _options :: [])

and gen__descriptor_proto_extension_range code x =
  let _start = Piqirun.gen_optional_field 1 gen__protobuf_int32 x.Descriptor_proto_extension_range.start in
  let _p_end = Piqirun.gen_optional_field 2 gen__protobuf_int32 x.Descriptor_proto_extension_range.p_end in
  Piqirun.gen_record code (_start :: _p_end :: [])

and gen__field_descriptor_proto code x =
  let _name = Piqirun.gen_optional_field 1 gen__string x.Field_descriptor_proto.name in
  let _extendee = Piqirun.gen_optional_field 2 gen__string x.Field_descriptor_proto.extendee in
  let _number = Piqirun.gen_optional_field 3 gen__protobuf_int32 x.Field_descriptor_proto.number in
  let _label = Piqirun.gen_optional_field 4 gen__field_descriptor_proto_label x.Field_descriptor_proto.label in
  let _p_type = Piqirun.gen_optional_field 5 gen__field_descriptor_proto_type x.Field_descriptor_proto.p_type in
  let _type_name = Piqirun.gen_optional_field 6 gen__string x.Field_descriptor_proto.type_name in
  let _default_value = Piqirun.gen_optional_field 7 gen__string x.Field_descriptor_proto.default_value in
  let _options = Piqirun.gen_optional_field 8 gen__field_options x.Field_descriptor_proto.options in
  Piqirun.gen_record code (_name :: _extendee :: _number :: _label :: _p_type :: _type_name :: _default_value :: _options :: [])
...
and gen__enum_descriptor_proto code x =
  let _name = Piqirun.gen_optional_field 1 gen__string x.Enum_descriptor_proto.name in
  let _value = Piqirun.gen_repeated_field 2 gen__enum_value_descriptor_proto x.Enum_descriptor_proto.value in
  let _options = Piqirun.gen_optional_field 3 gen__enum_options x.Enum_descriptor_proto.options in
  Piqirun.gen_record code (_name :: _value :: _options :: [])

and gen__enum_value_descriptor_proto code x =
  let _name = Piqirun.gen_optional_field 1 gen__string x.Enum_value_descriptor_proto.name in
  let _number = Piqirun.gen_optional_field 2 gen__protobuf_int32 x.Enum_value_descriptor_proto.number in
  let _options = Piqirun.gen_optional_field 3 gen__enum_value_options x.Enum_value_descriptor_proto.options in
  Piqirun.gen_record code (_name :: _number :: _options :: [])

and gen__service_descriptor_proto code x =
  let _name = Piqirun.gen_optional_field 1 gen__string x.Service_descriptor_proto.name in
  let _p_method = Piqirun.gen_repeated_field 2 gen__method_descriptor_proto x.Service_descriptor_proto.p_method in
  let _options = Piqirun.gen_optional_field 3 gen__service_options x.Service_descriptor_proto.options in
  Piqirun.gen_record code (_name :: _p_method :: _options :: [])

and gen__method_descriptor_proto code x =
  let _name = Piqirun.gen_optional_field 1 gen__string x.Method_descriptor_proto.name in
  let _input_type = Piqirun.gen_optional_field 2 gen__string x.Method_descriptor_proto.input_type in
  let _output_type = Piqirun.gen_optional_field 3 gen__string x.Method_descriptor_proto.output_type in
  let _options = Piqirun.gen_optional_field 4 gen__method_options x.Method_descriptor_proto.options in
  Piqirun.gen_record code (_name :: _input_type :: _output_type :: _options :: [])

and gen__file_options code x =
  let _java_package = Piqirun.gen_optional_field 1 gen__string x.File_options.java_package in
  let _java_outer_classname = Piqirun.gen_optional_field 8 gen__string x.File_options.java_outer_classname in
  let _optimize_for = Piqirun.gen_required_field 9 gen__file_options_optimize_mode x.File_options.optimize_for in
  let _java_multiple_files = Piqirun.gen_required_field 10 gen__bool x.File_options.java_multiple_files in
  let _cc_generic_services = Piqirun.gen_required_field 16 gen__bool x.File_options.cc_generic_services in
  let _java_generic_services = Piqirun.gen_required_field 17 gen__bool x.File_options.java_generic_services in
  let _py_generic_services = Piqirun.gen_required_field 18 gen__bool x.File_options.py_generic_services in
  let _uninterpreted_option = Piqirun.gen_repeated_field 999 gen__uninterpreted_option x.File_options.uninterpreted_option in
  Piqirun.gen_record code (_java_package :: _java_outer_classname :: _optimize_for :: _java_multiple_files :: _cc_generic_services :: _java_generic_services :: _py_generic_services :: _uninterpreted_option :: [])
...
and gen__message_options code x =
  let _message_set_wire_format = Piqirun.gen_required_field 1 gen__bool x.Message_options.message_set_wire_format in
  let _no_standard_descriptor_accessor = Piqirun.gen_required_field 2 gen__bool x.Message_options.no_standard_descriptor_accessor in
  let _uninterpreted_option = Piqirun.gen_repeated_field 999 gen__uninterpreted_option x.Message_options.uninterpreted_option in
  Piqirun.gen_record code (_message_set_wire_format :: _no_standard_descriptor_accessor :: _uninterpreted_option :: [])

and gen__field_options code x =
  let _ctype = Piqirun.gen_required_field 1 gen__field_options_ctype x.Field_options.ctype in
  let _packed = Piqirun.gen_optional_field 2 gen__bool x.Field_options.packed in
  let _deprecated = Piqirun.gen_required_field 3 gen__bool x.Field_options.deprecated in
  let _experimental_map_key = Piqirun.gen_optional_field 9 gen__string x.Field_options.experimental_map_key in
  let _uninterpreted_option = Piqirun.gen_repeated_field 999 gen__uninterpreted_option x.Field_options.uninterpreted_option in
  Piqirun.gen_record code (_ctype :: _packed :: _deprecated :: _experimental_map_key :: _uninterpreted_option :: [])
...
and gen__enum_options code x =
  let _uninterpreted_option = Piqirun.gen_repeated_field 999 gen__uninterpreted_option x.Enum_options.uninterpreted_option in
  Piqirun.gen_record code (_uninterpreted_option :: [])

and gen__enum_value_options code x =
  let _uninterpreted_option = Piqirun.gen_repeated_field 999 gen__uninterpreted_option x.Enum_value_options.uninterpreted_option in
  Piqirun.gen_record code (_uninterpreted_option :: [])

and gen__service_options code x =
  let _uninterpreted_option = Piqirun.gen_repeated_field 999 gen__uninterpreted_option x.Service_options.uninterpreted_option in
  Piqirun.gen_record code (_uninterpreted_option :: [])

and gen__method_options code x =
  let _uninterpreted_option = Piqirun.gen_repeated_field 999 gen__uninterpreted_option x.Method_options.uninterpreted_option in
  Piqirun.gen_record code (_uninterpreted_option :: [])

and gen__uninterpreted_option code x =
  let _name = Piqirun.gen_repeated_field 2 gen__uninterpreted_option_name_part x.Uninterpreted_option.name in
  let _identifier_value = Piqirun.gen_optional_field 3 gen__string x.Uninterpreted_option.identifier_value in
  let _positive_int_value = Piqirun.gen_optional_field 4 gen__uint64 x.Uninterpreted_option.positive_int_value in
  let _negative_int_value = Piqirun.gen_optional_field 5 gen__protobuf_int64 x.Uninterpreted_option.negative_int_value in
  let _double_value = Piqirun.gen_optional_field 6 gen__float64 x.Uninterpreted_option.double_value in
  let _string_value = Piqirun.gen_optional_field 7 gen__binary x.Uninterpreted_option.string_value in
  Piqirun.gen_record code (_name :: _identifier_value :: _positive_int_value :: _negative_int_value :: _double_value :: _string_value :: [])

and gen__uninterpreted_option_name_part code x =
  let _name_part = Piqirun.gen_required_field 1 gen__string x.Uninterpreted_option_name_part.name_part in
  let _is_extension = Piqirun.gen_required_field 2 gen__bool x.Uninterpreted_option_name_part.is_extension in
  Piqirun.gen_record code (_name_part :: _is_extension :: [])
...
let gen_descriptor_proto_extension_range x = gen__descriptor_proto_extension_range (-1) x
let gen_field_descriptor_proto x = gen__field_descriptor_proto (-1) x
let gen_field_descriptor_proto_type x = gen__field_descriptor_proto_type (-1) x
let gen_field_descriptor_proto_label x = gen__field_descriptor_proto_label (-1) x
let gen_enum_descriptor_proto x = gen__enum_descriptor_proto (-1) x
let gen_enum_value_descriptor_proto x = gen__enum_value_descriptor_proto (-1) x
...
let gen_uninterpreted_option_name_part x = gen__uninterpreted_option_name_part (-1) x
...
and default_binary () = ""
and default_file_descriptor_set () =
  {
...
and default_file_options () =
  {
    ...
    File_options.optimize_for = parse_file_options_optimize_mode (Piqirun.parse_default "\b\001");
    File_options.java_multiple_files = parse_bool (Piqirun.parse_default "\b\000");
    File_options.cc_generic_services = parse_bool (Piqirun.parse_default "\b\001");
    File_options.java_generic_services = parse_bool (Piqirun.parse_default "\b\001");
    File_options.py_generic_services = parse_bool (Piqirun.parse_default "\b\001");
    File_options.uninterpreted_option = [];
  }
and default_file_options_optimize_mode () = `speed
and default_message_options () =
  {
    Message_options.message_set_wire_format = parse_bool (Piqirun.parse_default "\b\000");
    Message_options.no_standard_descriptor_accessor = parse_bool (Piqirun.parse_default "\b\000");
    Message_options.uninterpreted_option = [];
  }
and default_field_options () =
  {
    Field_options.ctype = parse_field_options_ctype (Piqirun.parse_default "\b\000");
...
and default_enum_options () =
  {
    Enum_options.uninterpreted_option = [];
  }
...
and default_method_options () =
  {
    Method_options.uninterpreted_option = [];
  }
