...
and Piqi_bundle:
  sig
    type t = {
      mutable piqi: Piqi_piqi.piqi list;
    }
  end = Piqi_bundle
...
and gen__record code x =
  ...
  Piqirun.gen_record code (_field :: _protobuf_name :: _protobuf_custom :: _name :: _piq_positional :: _json_name :: [])
...
and gen__enum code x =
  ...
  Piqirun.gen_record code (_protobuf_name :: _protobuf_custom :: _name :: _option :: _protobuf_prefix :: _json_name :: [])
...
and gen__alias code x =
  ...
  Piqirun.gen_record code (_protobuf_name :: _name :: _protobuf_type :: _protobuf_wire_type :: _piqi_type :: _typename :: _piq_format :: _json_name :: [])
...
and gen__piqi_list code x =
  ...
  Piqirun.gen_record code (_protobuf_name :: _protobuf_custom :: _name :: _protobuf_packed :: _typename :: _piq_format :: _json_name :: [])
...
and gen__import code x =
  ...
  Piqirun.gen_record code (_modname :: _name :: [])
...
and gen__func code x =
  ...
  Piqirun.gen_record code (_name :: _output :: _error :: _input :: [])
