  ...
  in
    Piqirun.gen_record code
      [ _code; _deprecated; _protobuf_name; _mode; _name; _protobuf_packed;
        ...
        _piq_format; _ocaml_array; _ocaml_name; _piq_alias; _getopt_doc;
        _default; _ocaml_optional; _json_name ]
  ...
  in
    Piqirun.gen_record code
      [ _code; _deprecated; _protobuf_name; _name; _getopt_letter; _typename;
        _piq_format; _ocaml_name; _piq_alias; _getopt_doc; _json_name ]
