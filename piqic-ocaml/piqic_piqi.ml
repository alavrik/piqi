...
and
  Piqi_bundle : sig type t = { mutable piqi : Piqic_piqi.piqi list }
                     end =
    Piqi_bundle
  ...
  in
    Piqirun.gen_record code
      [ _code; _deprecated; _protobuf_name; _mode; _name; _protobuf_packed;
        ...
        _piq_format; _ocaml_array; _ocaml_name; _getopt_doc; _default;
