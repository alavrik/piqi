...
and Field:
  sig
    type t = {
      ...
      mutable piq_positional: bool option;
      mutable piq_flag_default: Piqic_piqi.piqi_any option;
...
and parse_field x =
  ...
  let _ocaml_array, x = Piqirun.parse_required_field 333250744 parse_bool x ~default:"\b\000" in
  let _ocaml_name, x = Piqirun.parse_optional_field 351856652 parse_string x in
  ...
  let _ocaml_optional, x = Piqirun.parse_required_field 488413665 parse_bool x ~default:"\b\000" in
  let _json_name, x = Piqirun.parse_optional_field 515275216 parse_string x in
  Piqirun.check_unparsed_fields x;
  {
    Field.code = _code;
...
and parse_import x =
  ...
  Piqirun.check_unparsed_fields x;
  {
    ...
    Import.ocaml_module = _ocaml_module;
  }
...
and gen__record code x =
  ...
  Piqirun.gen_record code (_field :: _protobuf_name :: _protobuf_custom :: _name :: _piq_allow_unnesting :: _piq_positional :: _ocaml_name :: _json_name :: [])
...
and gen__field code x =
  ...
  let _ocaml_array = Piqirun.gen_required_field 333250744 gen__bool x.Field.ocaml_array in
  ...
  let _ocaml_optional = Piqirun.gen_required_field 488413665 gen__bool x.Field.ocaml_optional in
  let _json_name = Piqirun.gen_optional_field 515275216 gen__string x.Field.json_name in
  Piqirun.gen_record code (_code :: _deprecated :: _protobuf_name :: _piq_flag_default :: _mode :: _internal :: _name :: _protobuf_packed :: _piq_positional :: _json_omit_missing :: _getopt_letter :: _typename :: _piq_format :: _ocaml_array :: _ocaml_name :: _piq_alias :: _getopt_doc :: _default :: _ocaml_optional :: _json_name :: [])
...
and gen__variant code x =
  ...
  Piqirun.gen_record code (_protobuf_name :: _protobuf_custom :: _name :: _protobuf_oneof :: _option :: _ocaml_name :: _json_name :: [])
...
and gen__piqi_list code x =
  ...
  let _ocaml_array = Piqirun.gen_required_field 333250744 gen__bool x.Piqi_list.ocaml_array in
...
and gen__piqi code x =
  ...
  Piqirun.gen_record code (_modname :: _included_file :: _file :: _protobuf_custom :: _import :: _custom_field :: _func :: _ocaml_module :: _protobuf_package :: _typedef :: [])
...
and gen__import code x =
  ...
  let _ocaml_module = Piqirun.gen_optional_field 375807149 gen__string x.Import.ocaml_module in
  Piqirun.gen_record code (_modname :: _name :: _ocaml_name :: _ocaml_module :: [])
...
and gen__any code x =
  ...
  Piqirun.gen_record code (_piq :: _xml :: _protobuf :: _json :: _typename :: [])
...
and default_field () =
  {
    ...
    Field.ocaml_array = parse_bool (Piqirun.parse_default "\b\000");
    Field.ocaml_name = None;
    Field.piq_alias = None;
    Field.getopt_doc = None;
    Field.default = None;
    Field.ocaml_optional = parse_bool (Piqirun.parse_default "\b\000");
...
and default_piqi_list () =
  {
    ...
    Piqi_list.ocaml_array = parse_bool (Piqirun.parse_default "\b\000");
